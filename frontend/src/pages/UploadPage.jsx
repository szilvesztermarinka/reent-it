...
const DataInputStep = React.memo(({ formData, setFormData, errors }) => (
  <div className="space-y-4">
    <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => setFormData("listtype", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        >
        ...
        {errors.listtype && (
          <p className="text-red-500 text-sm mt-1">{errors.listtype}</p>
        )}
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData("deposit", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          min="0"
        />
        {errors.deposit && (
    ...
    <div className="grid grid-cols-3 gap-4">
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData("bedroom", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData("livingroom", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData("balcony", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
    </div>
    ...
    <div className="grid grid-cols-3 gap-4">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData("county", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          placeholder="Pl.: Pest"
        />
        {errors.county && (
      ...
      <div>
        ...
        <select
          value={formData.yard}
          onChange={(e) => setFormData("yard", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        >
        ...
        {errors.yard && (
          <p className="text-red-500 text-sm mt-1">{errors.yard}</p>
        )}
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        <label className="block text-sm font-medium mb-1">
          Teljes terület (m², opcionális)
        </label>
        <input
          type="number"
          value={formData.landArea}
          onChange={(e) => setFormData("landArea", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          min="0"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData("built", e.target.value)}
          className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
    </div>
...
const ImageUploadStep = React.memo(
  ({ images, mainImage, handleImageUpload, setMainImage }) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <p>
            <span className="font-medium">Ingatlan típusa:</span>{" "}
          ...
          <p>
            <span className="font-medium">Hirdetés típusa:</span>{" "}
            {formData.listtype === "Rent" ? "Kiadó" : "Eladó"}
          </p>
          <p>
            <span className="font-medium">Ár:</span>{" "}
            {Number(formData.price).toLocaleString()} Ft
          </p>
          <p>
            <span className="font-medium">Kaució:</span>{" "}
            {Number(formData.deposit).toLocaleString()} Ft
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p>
            <span className="font-medium">Kert típusa:</span>{" "}
            {formData.yard === "Terrace"
              ? "Terasz"
              : formData.yard === "Garden"
              ? "Kert"
              : "Közös kert"}
          </p>
{/*           <p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p>
            <span className="font-medium">Erkélyek:</span>{" "}
            {formData.balcony || "0"}
          </p>
          {formData.landArea && (
            <p>
              <span className="font-medium">Teljes terület:</span>{" "}
              {formData.landArea} m²
            </p>
          )}
          {formData.built && (
...
const UploadPage = () => {
    ...
    (step) => {
      ...
      if (step === 1) {
        ...
        if (!formData.price || formData.price < 0)
          newErrors.price = "Érvénytelen ár";
        if (!formData.deposit || formData.deposit < 0)
          newErrors.deposit = "Érvénytelen kaució";
        if (!formData.description?.trim())
          newErrors.description = "Kötelező mező";
  ...
  const handleSubmit = async () => {
    ...
    formData.images.forEach((img) => {
      formDataToSend.append("images", img.file); // A mezőnévnek "images"-nek kell lennie
    });

    try {
      const response = await appAPI.post("/upload-listing", formDataToSend, {
        headers: {
          "Content-Type": "multipart/form-data", // Explicit típusmegadás
        },
      });
